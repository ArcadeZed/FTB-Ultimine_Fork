...
/// Register implementations of this via [RegisterRestrictionHandlerEvent]. See that class for more information.
@FunctionalInterface
public interface RestrictionHandler {
    /// Is the player allowed to do ultimining at this time?
    ///
    /// @param player the player being checked
    /// @return false to prevent ultimining, true to allow (note that if any handlers are registered, _all_ must return true for ultimining to be allowed)
